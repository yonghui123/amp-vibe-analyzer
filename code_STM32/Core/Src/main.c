...
/* USER CODE BEGIN PV */
static StackType_t guiTaskStack[4096];
static StaticTask_t guiTaskTCB;
/* USER CODE END PV */
...
/* USER CODE BEGIN PFP */
void StartGUITask(void *argument);  /* freertos.c 中定义 */
/* USER CODE END PFP */
...
int main(void)
{
  ...
  /* lv_init / DISP 驱动注册在 StartGUITask 中执行（main 栈仅 1KB） */
  /* USER CODE END 2 */
  ...
  static const osThreadAttr_t guiTask_attributes = {
    .name = "guiTask",
    .stack_mem = guiTaskStack,
    .stack_size = sizeof(guiTaskStack),
    .cb_mem = &guiTaskTCB,
    .cb_size = sizeof(guiTaskTCB),
    .priority = (osPriority_t) osPriorityAboveNormal,
  };
  if (osThreadNew(StartGUITask, NULL, &guiTask_attributes) == NULL) {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AD7606_OS2_Pin|AD7606_RAGE_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : LCD_PWM_NOUSE_Pin */
  GPIO_InitStruct.Pin = LCD_PWM_NOUSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(LCD_PWM_NOUSE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : AD7606_RESET_Pin AD7606_OS2_Pin AD7606_RAGE_Pin */
  GPIO_InitStruct.Pin = AD7606_RESET_Pin|AD7606_OS2_Pin|AD7606_RAGE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : AD7606_OS1_Pin */
  ...
  /*Configure GPIO pin : AD7606_OS0_Pin */
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  {
    HAL_IncTick();
    lv_tick_inc(1);  /* LVGL 时钟节拍 (TIM1 = 1ms) */
  }
