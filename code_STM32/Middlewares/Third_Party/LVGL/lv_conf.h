...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (64U * 1024U)          /* 64KB: 7寸 GUI 多 Tab+图表 */
...
#define LV_MEMCPY_MEMSET_STD 1    /*启用标准memcpy/memset，避免ARM Compiler链接问题*/
...
#ifndef PC_SIMULATOR
#define LV_INDEV_DEF_READ_PERIOD 10     /* STM32: 更快触摸轮询 */
#else
